...
/**
 * Getting the Fabric Client Object 
 * @param {string} userorg Organization name of User 
 * @param {string} [username] Username whose context is required
 * @return {obj} Client object with or without user context  
 */
...
var getRegisteredUser = async function(username, userOrg, isJson) {
	try {
		...
		if (user && user.isEnrolled()) {
			...
			try{ aff_res=await affiliation_service.create({
				name: userOrg.toLowerCase()
			}, adminUserObj)
			}catch(err){
				console.log(err)
			}
